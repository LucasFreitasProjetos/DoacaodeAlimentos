...
<head>
    ...
    <title>Nova Doação - Sistema de Doações</title>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="form-title">➕ Nova Doação</h2>
                    ...
                    try {
                        ...
                        if (doadorId > 0 && instituicaoId > 0 && descricao != null && !descricao.isEmpty() && dataStr != null && !dataStr.isEmpty()) {
                            ...
                            if (controller.cadastrar(doacao)) {
                                response.sendRedirect("listar.jsp?mensagem=" + encode("Doação registrada com sucesso") + "&tipo=success");
                                return;
                            } else {
            %>
                                <div class="alert alert-danger">Erro ao registrar doação. Tente novamente.</div>
            <%
                            }
                        } else {
            %>
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="descricao" name="descricao" required placeholder="Descreva o que será doado (ex: 20kg de arroz, 10 latas de óleo, etc)"></textarea>
                </div>
