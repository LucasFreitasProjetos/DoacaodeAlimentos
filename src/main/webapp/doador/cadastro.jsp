...
<head>
    ...
    <title>Novo Doador - Sistema de Doações</title>
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="form-title">➕ Novo Doador</h2>
                ...
                if (request.getMethod().equals("POST")) {
                    ...
                    if (nome != null && !nome.isEmpty() && email != null && !email.isEmpty()) {
                        ...
                        if (controller.cadastrar(doador)) {
                            response.sendRedirect("listar.jsp?mensagem=" + encode("Doador cadastrado com sucesso") + "&tipo=success");
                            return;
                        } else {
            %>
                            <div class="alert alert-danger">Erro ao cadastrar doador. Tente novamente.</div>
            <%
                        }
                    } else {
            %>
